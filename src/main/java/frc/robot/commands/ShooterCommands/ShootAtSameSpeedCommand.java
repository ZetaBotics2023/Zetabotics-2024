...
public class ShootAtSameSpeedCommand extends Command {
    ...
    public ShootAtSameSpeedCommand(ShooterSubsystem shooterSubsystem, IntakeSubsystem intakeSusbsystem, PivotSubsystem pivotSubsystem, IntakeSensorSubsystem intakeSensorSubsystem){
